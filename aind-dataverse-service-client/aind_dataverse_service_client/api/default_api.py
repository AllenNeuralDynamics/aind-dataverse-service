...
from aind_dataverse_service_client.api_client import ApiClient, RequestSerialized
from aind_dataverse_service_client.api_response import ApiResponse
from aind_dataverse_service_client.rest import RESTResponseType
...
class DefaultApi:
    ...
    def get_funding(
        ...
        ## Funding Retrieves funding and project information.
    ...
    def get_table(
        ...
        columns: Annotated[Optional[StrictStr], Field(description="Comma-separated column names to select from the table")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="OData-style filter expression")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param columns: Comma-separated column names to select from the table
        :type columns: str
        :param filter: OData-style filter expression
        :type filter: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    @validate_call
    def get_table_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_table_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
