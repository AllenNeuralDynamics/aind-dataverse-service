...
from aind_dataverse_service_client.models.funding_model import FundingModel
...
with aind_dataverse_service_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Funding
        api_response = api_instance.get_funding()
...
with aind_dataverse_service_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Table
        api_response = api_instance.get_table(entity_set_table_name, columns=columns, filter=filter)
