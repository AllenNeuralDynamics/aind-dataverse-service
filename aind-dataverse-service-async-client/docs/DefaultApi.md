# aind_dataverse_service_async_client.DefaultApi
...
from aind_dataverse_service_async_client.models.funding_model import FundingModel
...
async with aind_dataverse_service_async_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Funding
        api_response = await api_instance.get_funding()
...
async with aind_dataverse_service_async_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Table Info
        api_response = await api_instance.get_table_info()
