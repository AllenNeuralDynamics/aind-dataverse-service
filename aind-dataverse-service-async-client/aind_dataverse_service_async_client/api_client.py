...
from aind_dataverse_service_async_client.api_response import ApiResponse, T as ApiResponseT
import aind_dataverse_service_async_client.models
from aind_dataverse_service_async_client import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aind_dataverse_service_async_client.models, klass)
